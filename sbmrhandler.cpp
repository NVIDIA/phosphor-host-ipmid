                                ...
                                const std::string& value)
{
    ...
    ec = ipmi::setDbusProperty(
        ctx, sbmrHostStateObject.second, sbmrHostStateObject.first,
                                          ...
                                          uint64_t timeStamp)
{
    ...
    ec = ipmi::setDbusProperty(
        ctx, sbmrHostStateObject.second, sbmrHostStateObject.first,
        sbmrHostStateIntf, "BootProgressLastUpdate", timeStamp);
    if (ec.value())
    {
        lg2::error(
    ...
    uint8_t instance)
{
    ...
    BootProgressCode bpCode(
        ...
        {});
    ec = ipmi::setDbusProperty(
        ctx, sbmrBootStateObject.second, sbmrBootStateObject.first,
